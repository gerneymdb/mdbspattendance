...
return array(
	...
	'groups' => array(
		...
		-1 => array("name" => "Banned", "roles" => array('banned')),
         1 => array("name" => "Users", "roles" => array('user')),
         2 => array("name" => "Administrators", "roles" => array('administrator'))
	),
	...
	'roles' => array(
		 ...
		 */
		"user" => array(
            "attendance"         => array('create', 'read'),
            "attendance_history" => array('read'),
            "leave"              => array('create', 'read', 'update', 'delete'),
            "leave_history"      => array('read')
        ),
        "administrator" => array(
            "system_settings"   => array("create", "read", "update", "delete"),
            "work_schedule"     => array("create", "read", "update", "delete"),
            "leave_applications" => array("create", "read", "update", "delete"),
            "holidays" => array("create", "read", "update", "delete"),
            "manage_employees" => array("create", "read", "update", "delete"),
            "manage_attendance" => array("create", "read", "update", "delete"),
            "new_admin" => array("create", "read", "update", "delete"),
        )
	),
