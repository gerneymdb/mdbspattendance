...
class Controller_Login extends \Fuel\Core\Controller_Template {
    ...
    public function action_firstLogin() {
        ...
        $data["lang"] = lang::get("first_login_form");

        // if first time and authenticated then load first time
        // login form
        $this->template->title = lang::get("title");
        $this->template->content = View::forge('login/first_time_login', $data);
    ...
    public function action_schedulePwdReset() {
        ...
        $data["lang"] = lang::get("scheduled_pwd_reset");

        // if expired password and authenticated then load change password form
        $this->template->title = lang::get("title");
        $this->template->content = View::forge('login/scheduled_pwd_reset', $data);
    ...
    public function post_employeeLogin(){
        ...
        if(Security::check_token()){
            ...
            if($val->run()){
                ...
                if($this->check_user($userid)){
                    ...
                    if($time_delay <= 0){
                        ...
                        if(Auth::login($userid, $password)){
                            ...
                            // redirect to login page
                            $msg[] = lang::get("login_form.form_error.incorrect");
                            Session::set_flash("msg", $msg);
                            \Fuel\Core\Response::redirect("login", "refresh");
                        }
                        ...
                        $msg[] = lang::get("login_form.form_error.many_attempt").$time_delay;
                        Session::set_flash("msg", $msg);
                        \Fuel\Core\Response::redirect("login", "refresh");
                ...
                // fields are empty
                $msg[] = lang::get("login_form.form_error.empty_field");
                Session::set_flash("msg", $msg);
                \Fuel\Core\Response::redirect("login", "refresh");
            }
        ...
        if(Security::check_token()){
            ...
            if($val->run()){
                ...
                if(Auth::change_password($old_password, $new_password, $userid)){
                    ...
                    $msg .= "<strong>".lang::get("first_login_form.success")."</strong>";
                    $msg .= "</div>";
                    ...
                    $msg[] = lang::get("first_login_form.form_error.incorrect_old_pwd");
                    Session::set_flash("msg", $msg);
                    \Fuel\Core\Response::redirect("login/firstLogin", "refresh");
        ...
        if(Security::check_token()){
            ...
            if($val->run()){
                ...
                if(Auth::change_password($old_password, $new_password, $userid)){
                    ...
                    $msg  = "<div class='alert alert-success'>";
                    $msg .= "<strong>".lang::get("scheduled_pwd_reset.success")."</strong>";
                    $msg .= "</div>";
                    Session::set_flash("msg", $msg);
                    Session::set_flash("location", "login/redirectUser");
                    \Fuel\Core\Response::redirect("messages");
                    ...
                    // old_password is not correct
                    $msg[] = lang::get("scheduled_pwd_reset.form_error.incorrect_old_pwd");
                    Session::set_flash("msg", $msg);
                    \Fuel\Core\Response::redirect("login/schedulePwdReset", "refresh");
