    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="<?php echo $base_url . 'administrator/edit_data_settings'?>" class="form_system_setting clearfix" method="post" >
                ...
                <div class="form-group default-password">
                    <label for="">Set default password to:</label>
                    <input type="text" class="form-control" name="default_pwd" placeholder="default-password" value="<?php echo $default_setting->default_pwd ?>"/>
                </div>

                <p class="input-label">Reset password after:</p>
                <div class="input-group">
                    <input type="number" class="form-control" name="reset_pwd_after" placeholder="the number of days before reset password" aria-describedby="basic-addon2"
                           value="<?php echo (ceil($default_setting->reset_pwd_after/84600))?>"/>
                    <span class="input-group-addon" id="basic-addon2">Days</span>
                </div>

                <p class="input-label">Session Timeout after:</p>
                <div class="input-group">
                    <input type="number" class="form-control" name="session_timeout_after" placeholder="session timesout after number of hrs" aria-describedby="basic-addon2"
        ...
        <div class="col-md-6">
            ...
            <div class="add-new-category clearfix">
                <p><strong>Add new leave category</strong></p>
                <form action="<?php echo $base_url . 'administrator/add_leave_category'?>" class="form_system_setting" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="leave_name" placeholder="indicate name of new leave category" id="leavename" class="form-control" />
                    </div>
                    <div class="form-group">
                        <label for="days_alloted">Days Alloted</label>
                        <input type="number" name="days_alloted" placeholder="number of days alloted for this leave" id="days_alloted" class="form-control" />
                    </div>
            ...
            <div class="category-leave-list">
                <table class="table table-responsive">
                    <caption><strong>Leave Category List</strong></caption>
                    <thead>
                        <tr>
                            <th>Leave Name</th>
                            <th>Days Alloted</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Edit Leave Category Information</h4>
            </div>
            <div class="modal-body">
                <form action="#" id="leave_cat_form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="leave_name" id="leave_name" placeholder="Leave category name" value=""  class="form-control"/>
                    </div>
                    <div class="form-group">
                        <label for="daysalloted">Days Alloted</label>
                        <input type="number" name="days_alloted" id="daysalloted" placeholder="Days Alloted" value="" class="form-control"/>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                <button type="button" class="btn btn-primary" id="save_changes"><i class="fa fa-save"></i> Save changes</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="delete_leave" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Delete Leave Category</h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                <button type="button" class="btn btn-danger" id="delete_leave_cat"><i class="fa fa-trash-o"></i> Delete</button>
            </div>
        </div>
    </div>
</div>