    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="firstLogin-form">
                ...
                <?php echo \Fuel\Core\Form::open(array("action"=>"login/newPassword", "method"=>"post", "class"=>"form-firstLogin", "id"=>"firstLogin-form"))?>
                    <h2 class="form-firstLogin-heading"><?php echo $lang["form_heading"]?></h2>
                    <hr />
                    <?php
